...
//    instance.registerFactory<UpdateServiceUsecase>(() =>UpdateServiceUsecase(instance()));
  //  instance.registerFactory<StoreServiceUsecase>(() =>StoreServiceUsecase(instance()));

    instance.registerFactory<ServiceBloc>(() =>ServiceBloc(instance(),instance(),instance()));
  }
...
Future<void>initUserNavModule() async{
 // if(!GetIt.I.isRegistered<DeleteEmployeeUsecase>()) {
    ...
    instance.registerFactory<UserNavBloc>(() =>UserNavBloc(instance(),instance(),instance(),instance()));
 // }
}
