...
class NavPage extends StatelessWidget {
 ...
 final GlobalKey<CurvedNavigationBarState> _bottomNavigationKey = GlobalKey();
  final List<Widget> bodyList = [  ProductUser(), ServiceUser(),SalonUser(),BookServiceUser()];
            ...
            appBar: context.read<UserNavBloc>().index > 5
              ...
              actions: [
                context.read<UserNavBloc>().index==0?
                    IconButton(onPressed: (){}, icon:Icon( Icons.shopping_cart,color: ColorManager.primary6,size: 30)):SizedBox(),
    ...
    return Container(
        ...
        child: CurvedNavigationBar(
          ...
          onTap: (index) {
            ...
            index==0? BlocProvider.of<UserNavBloc>(context).add(AllProduct()):index==1?
